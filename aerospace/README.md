...
My custom configuration for the AeroSpace tiling window manager.
...
Ctrl + h (Left) / j (Down) / k (Up) / l (Right)
...
Ctrl + ; (Next window appears below)

Split Horizontal

Ctrl + ' (Next window appears to the side)
